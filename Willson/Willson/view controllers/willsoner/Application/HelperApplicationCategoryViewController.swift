//
//  HelperApplicationCategoryViewController.swift
//  Willson
//
...
class HelperApplicationCategoryViewController: UIViewController {
    ...
    @IBAction func tappedNextButton(_ sender: Any) {
        ...
        let vc = UIStoryboard(name: "HelperApplication", bundle: nil).instantiateViewController(withIdentifier: "HelperApplicationDetailCategoryViewController")
...
extension HelperApplicationCategoryViewController: UICollectionViewDelegate {
...
extension HelperApplicationCategoryViewController: UICollectionViewDataSource {
...
extension HelperApplicationCategoryViewController: UICollectionViewDelegateFlowLayout {
